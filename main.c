...
game_t *game_init(game_config_t config) {
  ...
  game->resources.window = SDL_CreateWindow(
      config.window_title, config.window_pos_x, config.window_pos_y,
  ...
  game->resources.renderer = SDL_CreateRenderer(game->resources.window,
                                                RENDERER_INDEX, RENDERER_FLAGS);
